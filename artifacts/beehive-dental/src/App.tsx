...
import { Phone, Calendar, Clock, MapPin, CheckCircle, Shield, Stethoscope, Coffee, Headphones, HeartHandshake, ChevronRight, Menu, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-background flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-50 w-full bg-background/90 backdrop-blur-md border-b border-border/50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            <a href="#services" className="text-foreground/80 hover:text-secondary transition-colors">Services</a>
            <a href="#about" className="text-foreground/80 hover:text-secondary transition-colors">About</a>
            <a href="#new-patients" className="text-secondary font-semibold">New Patients</a>
            <a href="#resources" className="text-foreground/80 hover:text-secondary transition-colors">Resources</a>
          </nav>
          <div className="hidden md:flex items-center gap-4">
            <a href="tel:9057885555" className="text-sm font-medium text-foreground/80 hover:text-foreground flex items-center gap-2 transition-colors">
              <Phone className="w-4 h-4" />
              (905) 788-5555
            </a>
            <Button asChild className="bg-secondary hover:bg-secondary/90 text-white rounded-full px-6 shadow-md hover:shadow-lg transition-all">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          ...
          >
            ...
            <motion.div variants={FADE_UP} className="flex flex-col sm:flex-row items-center gap-4">
              <Button asChild size="lg" className="w-full sm:w-auto bg-secondary hover:bg-secondary/90 text-white rounded-full px-8 h-14 text-base shadow-xl hover:shadow-secondary/20 transition-all group">
                <a href="https://app.nexhealth.com/appt/beehive-dental" target="_blank" rel="noreferrer">
                  Book Online
                  <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                </a>
              </Button>
              <Button asChild variant="outline" size="lg" className="w-full sm:w-auto bg-white/50 backdrop-blur-sm border-border/50 hover:bg-white/80 rounded-full px-8 h-14 text-base transition-all">
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <Button asChild variant="outline" className="bg-white hover:bg-muted border-border rounded-xl h-12 px-8">
      ...
      <section className="py-24 bg-card border-t border-border/50">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <Button asChild className="w-full bg-accent hover:bg-accent/90 text-white rounded-xl h-12">
          ...
          >
            ...
            <Button asChild variant="outline" className="w-full bg-white hover:bg-muted border-border rounded-xl h-12 text-foreground">
            ...
            >
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  ...
                  <a href="https://maps.app.goo.gl/vLrG9yct1S2qZwzW8" target="_blank" rel="noreferrer" className="text-secondary font-medium hover:underline inline-flex items-center gap-1">
      ...
      <section className="py-24 bg-foreground text-background text-center relative overflow-hidden">
        ...
        >
          ...
          <Button asChild size="lg" className="bg-secondary hover:bg-secondary/90 text-white rounded-full px-10 h-16 text-lg shadow-xl shadow-secondary/20 transition-all group">
            <a href="https://app.nexhealth.com/appt/beehive-dental" target="_blank" rel="noreferrer">
              Book Online Now
